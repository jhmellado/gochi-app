...
import EncabezadoCultivo from "../cultivos/componentes/EncabezadoCultivo";
import InfoBeneContraCultivo from "../cultivos/componentes/InfoBeneContraCultivo";
...
const Cultivo = (props) => {
  ...
  useEffect(() => {
    ...
    const obtenerDatos = async () => {
      const data = await fetch(`http://192.168.1.13:5000/cultivos/${props.id}`);
  ...
  return (
    <div className="container">
      <EncabezadoCultivo
        ...
        info_como_cultivar={cultivo.cul_como_cultivar_go}
        info_buenos_vecinos={cultivo.cul_buenos_vecinos_go}
        info_malo_vecinos={cultivo.cul_malos_vecinos_go}
        info_fertilizantes={cultivo.cul_fertelizantes_go}
        info_plagas={cultivo.cul_plagas_comunes}
      ...
      <div className="row g-5">
        <div className="col-md-8">
          <h3 className="pb-4 mb-4 fst-italic border-bottom">Aprende más sobre este cultivo</h3>

          <article className="blog-post">
            <h2 className="blog-post-title mb-1">Cuando Cultivar</h2>
          ...
          <nav className="blog-pagination" aria-label="Pagination">
            ...
            <a className="btn btn-outline-secondary rounded-pill disabled" href="/">Newer</a>
          </nav>
        </div>
