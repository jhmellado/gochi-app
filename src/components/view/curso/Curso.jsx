...
useEffect(()=> {
    ...
    const data = [{
        ...
        "category": "Varios",
        "about": "La germinación permite facilitar el nacimiento precoz de las diferentes plantas a cultivar, el máximo rendimiento de la semilla y, por ende, de plantas útiles, la obtención de mejores frutos y mayores cosechas, evitando el deshijamiento (eliminación de plántulas por exceso).",
        "description": "Los germinadores y propagadores nos apoyarán a la hora de procesar o germinar nuestras semillas en el período invernal, cuando es un poco más difícil obtener condiciones idóneas de humedad, temperatura y necesitamos protegerles del viento para que puedan prosperar.",
        "intructor": [{
            "name": "Jeferson Mellado",
            "email": "jefersonmellado@gmail.com",
            "oficio": "TNS Analista Programador",
            "url_profile_image":"https://scontent.fscl13-2.fna.fbcdn.net/v/t1.6435-9/147255901_255408999487770_84653461078968456_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeF0K8XTxwYqZ-sdtuU6EOtoJuj59eskrF8m6Pn16ySsX0-TU0_FoQby5fUEF_dscBcFOd0Nj4Erct7ftsaAx_nP&_nc_ohc=9iVfj0rnWCoAX_X464M&_nc_ht=scontent.fscl13-2.fna&oh=00_AT8SjQVXVJjvLsHf66A89A0VpJy-RyS-ngpYW1GzvX3Uwg&oe=630398F7",
            "socialmedia": [{
                "name": "instagram",
                "url_perfil":"https://www.instagram.com/j3f3rm0n/",
                "url_image_social": "https://assets.stickpng.com/images/580b57fcd9996e24bc43c521.png"
            }]
        }],
        "secciones": [{
    ...
    const data_curso = data.map((info_curso) =>
        info_curso
    );
    ...
    <div className='row'>
        <div className="col-lg-9">
            <div className="container">
                ...
                <div className="row">
                    <Acercade about = {data_curso[0].about}
                              ...
                              url_image_social = {data_curso[0].intructor[0].socialmedia[0].url_image_social}/>
                </div>       
            </div> 
        </div>
        <div className="col">
